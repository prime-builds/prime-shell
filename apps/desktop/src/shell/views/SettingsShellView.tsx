...
interface SearchableItem {
  ...
  title: string;
  description: string;
  section: "appearance" | "layout" | "analysis" | "text-utility";
  sectionTitle: string;
  keywords: string[];
}
...
const STATIC_SEARCHABLE_ITEMS: SearchableItem[] = [
  ...
  {
    id: "documentAnalysis.maxTopTerms",
    title: "Top Terms Limit",
    description: "Maximum number of frequent terms to extract and rank in document analysis histograms.",
    section: "analysis",
    sectionTitle: "Document Analysis",
    keywords: ["analysis", "document", "terms", "histogram", "limit", "top terms"],
  },
  {
            ...
            filteredItems.map((item) => (
              <Card key={item.id} data-testid={`search-item-${item.id}`}>
                ...
                <div style={{ marginTop: "12px" }}>
                  ...
                  {item.id === "documentAnalysis.maxTopTerms" && (
                    <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                      <Button
                      ...
                      <Button
                        appearance="subtle"
                        icon={<ArrowReset20Regular />}
                        onClick={() => void resetSetting("documentAnalysis", "maxTopTerms")}
                        size="small"
                        data-testid="reset-maxTopTerms-btn"
                      >
                        Reset
                      </Button>
                    </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <Card role="region" aria-label="Document Analysis Settings">
                ...
                <div>
                  ...
                  >
                    Reset Document Analysis Settings
                  </Button>
                </div>
              </Card>
            </div>
